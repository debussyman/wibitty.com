...
proto.transit_realtime.FeedHeader.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    default:
      jspb.Message.readBinaryExtension(msg, reader, proto.transit_realtime.FeedHeader.extensionsBinary,
...
proto.transit_realtime.Position.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    default:
      jspb.Message.readBinaryExtension(msg, reader, proto.transit_realtime.Position.extensionsBinary,
...
proto.transit_realtime.EntitySelector.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    default:
      jspb.Message.readBinaryExtension(msg, reader, proto.transit_realtime.EntitySelector.extensionsBinary,
